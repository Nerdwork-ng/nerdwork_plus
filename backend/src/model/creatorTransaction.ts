...
// Transaction status
export const creatorTransactionStatusEnum = pgEnum("creator_transaction_status", [
  "pending",
  "completed",
...
export const creatorTransactions = pgTable("creator_transactions", {
  ...
  sourceUserTransactionId: uuid("source_user_transaction_id")
    .references(() => userTransactions.id), // Link to the user transaction that generated this earning
  ...
  platformFeePercentage: decimal("platform_fee_percentage", { precision: 5, scale: 4 }).default("0.30"), // 30%
