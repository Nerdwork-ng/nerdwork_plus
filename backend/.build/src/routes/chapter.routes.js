 ...
 */
router.post("/create", chapter_controller_1.createChapter);
/**
 * @swagger
 * /chapters/draft:
 *   post:
 ...
 *         description: Server error
 */
router.post("/draft", chapter_controller_1.createDraft);
/**
 * @swagger
 ...
 *         description: Server error
 */
router.get("/by-comic/creator/:slug", chapter_controller_1.fetchChaptersByComicSlugForCreators);
/**
 * @swagger
 ...
 *         description: Server error
 */
router.get("/by-comic/reader/:slug", chapter_controller_1.fetchChaptersByComicSlugForReaders);
/**
 * @swagger
 ...
 *         description: Server error
 */
router.get("/by-code/:code", chapter_controller_1.fetchChapterByUniqueCode);
/**
 * @swagger
 ...
 *         description: Server error
 */
router.get("/pages/:chapterId", chapter_controller_1.fetchChapterPagesById);
/**
 * @swagger
 ...
 *         description: Server error
 */
router.post("/draft/publish", chapter_controller_1.publishDraft);
/**
 * @swagger
 ...
 *         description: Server error
 */
router.delete("/delete/:code", chapter_controller_1.deleteChapter);
/**
 * @swagger
 * /chapters/purchase:
 *   post:
 ...
 */
router.post("/purchase", chapter_controller_1.buyChapter);
/**
 * @swagger
 * /chapters/paid:
 *   get:
 ...
 *         description: Internal server error
 */
router.get("/paid", chapter_controller_1.fetchAllPaidChapters);
/**
 * @swagger
 * /chapters/view:
 *   post:
 ...
 *         description: Internal server error
 */
router.post("/view", chapter_controller_1.addChapterView);
/**
 * @swagger
 ...
 *         description: Internal server error
 */
router.post("/:chapterId/like", chapter_controller_1.toggleChapterLike);
