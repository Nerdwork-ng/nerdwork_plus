 ...
 */
router.post("/creator", profile_controller_1.addCreatorProfile);
/**
 * @route   POST /profile/reader
 * @desc    Create a Reader Profile
 * @access  Private (after signup)
 */
router.post("/reader", profile_controller_1.addReaderProfile);
/**
 * @route   GET /profile/creator
 * @desc    Get Creator Profile
 * @access  Private (Jwt required)
 */
router.get("/creator", profile_controller_1.getCreatorProfile);
/**
 * @route   GET /profile/reader
 * @desc    Get Reader Profile
 * @access  Private (Jwt required)
 */
router.get("/reader", profile_controller_1.getReaderProfile);
/**
 * @route   PUT /profile/reader/pin
 * @desc    update Reader Profile pin
 * @access  Private (Jwt required)
 */
router.put("/reader/pin", profile_controller_1.updateReaderProfilePin);
/**
 * @route   PUT /profile/creator/pin
 * @desc    update Creator Profile pin
 * @access  Private (Jwt required)
 */
router.put("/creator", profile_controller_1.updateCreatorProfile);
/**
 * @swagger
 * tags:
 *   name: Profiles
